...
Заказ продуктов из ресторана 'Мигом'. Доставим за 20 минут!
![Заказ продуктов из ресторана 'Мигом'. Доставим за 20 минут!](media/start.gif)
...
* дополнительно установить все переменные проекта в файле `.env`
