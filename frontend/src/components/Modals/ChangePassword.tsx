...
const ChangePasswordModal: React.FC<{
    ...
    return (
        <div
            ...
            aria-modal="true"
        >
            <div className="border border-gray-200 rounded-3xl relative w-full h-full bg-white md:h-auto shadow-lg p-6 md:mx-0 md:max-w-[600px] md:max-h-[80vh] overflow-auto">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-9 md:gap-3">
                    ...
                    <div className="flex items-center justify-center gap-3">
                        <button type="submit" className="big__button bg-red-100 text-red-500" disabled={loading} aria-busy={loading}>
                            {"Изменить"}
                        </button>
